...
const reducer = (accumulator, currentValue) => accumulator + currentValue;
	...
	const computeCartTotal = (arr) => {
	let prices = [];
	let total = 0;
	if (Object.keys(arr).length === 0 || arr === undefined) return;
			...
			<div className="w-10/12 mx-auto">  
				...
				<div className="flex justify-end">
					<div className="border border-grey-200 mb-6 w-full lg:w-6/12 px-3 py-4">	
						...
						<div onChange={this.handleOnChange} className="shipping-option py-2">
						...
						<div onChange={this.handleOnChange} className="payment-method py-2">
						...
						<div className="stripe-section bg-gray-200 p-3">	
							...
							<label htmlFor="credit" className="text-gray-500 font-semibold">Credit Card:&nbsp;</label>
							<CardInput />
