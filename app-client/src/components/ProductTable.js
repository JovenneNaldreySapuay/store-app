                    ...
                    <table className="border w-full text-left shadow-sm">
                        ...
                        <tbody>
                            {productsData.map((product, idx) => (
                                <tr key={idx}>
                                    <td><img src={product.image} alt={product.title} width={60} style={{margin: 'auto'}} /></td>
                                    ...
                                    <div className="delete">
                                        ...
                                        onClick={() => { if (window.confirm(`Are you sure to delete this product?`)) deleteProduct(product._id) }}
                                        >Delete</button>
                                    </div>
                                    </td>
                                </tr>
...
export default connect(mapStateToProps, { fetchProducts, deleteProduct })(ProductTable);
