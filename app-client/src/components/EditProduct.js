...
class EditProduct extends Component {
	...
	static getDerivedStateFromProps(props, state) {
		if (props.product._id !== state.data._id) {
			...
			const { _id, title, description, slug, price, category, stock } = props.product;
		 		...
		 		<div className="w-full bg-white mt-3 pl-64">
					<div className="p-4 text-sm text-gray-800">
						...
						<div>
							...
							<label htmlFor="title" className="text-gray-600 pb-1 block">Title</label>
							<input
...
export default connect(mapStateToProps, { fetchSingleProduct, updateProduct })(EditProduct);
