          ...
          <div className="p-4 text-sm text-gray-800">
            ...
            <Form onSubmit={this.handleOnSubmit} loading={loading}>
              <Form.Field error={!!errors.email}>
                <label htmlFor="email" className="text-gray-600 pb-1 block">
                  Email
                </label>
                <input
              ...
              <Form.Field error={!!errors.fullName}>
                <label htmlFor="fullName" className="text-gray-600 pb-1 block">
                  Full Name
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
              ...
              <Form.Field error={!!errors.phone}>
                <label htmlFor="phone" className="text-gray-600 pb-1 block">
                  Phone
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
              ...
              <Form.Field error={!!errors.address}>
                <label htmlFor="address" className="text-gray-600 pb-1 block">
                  Address
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
              ...
              <Form.Field error={!!errors.city}>
                <label htmlFor="city" className="text-gray-600 pb-1 block">
                  City
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
              ...
              <Form.Field error={!!errors.province}>
                <label htmlFor="province" className="text-gray-600 pb-1 block">
                  Province
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
              ...
              <Form.Field error={!!errors.country}>
                <label htmlFor="country" className="text-gray-600 pb-1 block">
                  Country
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
              ...
              <Form.Field error={!!errors.zipcode}>
                <label htmlFor="zipcode" className="text-gray-600 pb-1 block">
                  Zip Code
                </label>
                <input
                  className="bg-white focus:outline-none border border-gray-300 text-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
